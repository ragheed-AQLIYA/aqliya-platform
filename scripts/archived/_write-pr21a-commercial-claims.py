"""Write PR-21a commercial-claims.ts (UTF-8) matching sales-commercial-claims.test.ts."""
from pathlib import Path

TARGET = Path(__file__).resolve().parents[1] / "src/lib/sales/commercial-claims.ts"

CONTENT = r'''import { randomUUID } from "crypto";
