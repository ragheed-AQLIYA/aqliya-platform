...
async function main() {
  ...
  await prisma.risk.createMany({
    data: [
      { decisionId: decision.id, description: 'Resource overallocation', level: 'MEDIUM' },
      { decisionId: decision.id, description: 'Training material price volatility', level: 'LOW' },
      { decisionId: decision.id, description: 'Client payment delays', level: 'MEDIUM' },
    ],
  })
