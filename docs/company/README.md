...
Company positioning, identity, and commercial reference documents.

## Brand

- `docs/brand/` — Visual identity system, brand assets, component library, dashboard density governance, quick reference
...
- `docs/execution/` — Engineering operating protocol, architecture guards, build plans, UI rules
- `docs/operations/` — Backup schedules and operational runbooks
