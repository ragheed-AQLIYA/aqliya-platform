...
> **ARCHIVED 2026-06-01** — Stale. Describes AuditOS-only build and Tender Decisions era. See `docs/source-of-truth/PRODUCT_STATUS_MATRIX.md` and `docs/source-of-truth/ROUTE_STRATEGY.md` for current boundaries.
