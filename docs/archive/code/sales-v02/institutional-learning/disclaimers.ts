...
export const INSTITUTIONAL_LEARNING_DISCLAIMER_AR =
  "مخرجات التعلم المؤسسي مستخرجة بقواعد من الفوز/الخسارة والنشاط والإشارات والأدلة — ليست سياسة تلقائية. المراجعة البشرية مطلوبة قبل تعديل أدلة التشغيل التجاري.";
