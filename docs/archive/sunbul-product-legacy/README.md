# Archived — Sunbul Product Docs (Legacy)

**Archived:** 2026-06-01  
**Reason:** Sunbul was a legacy product name; WorkflowOS is the canonical product.

**Canonical docs:** `docs/product/workflowos/README.md`

All documents in this directory describe the WorkflowOS product under the old "Sunbul" name. Preserved for historical reference only.
...
All documents in `docs/archive/sunbul-product-legacy/` describe the WorkflowOS product under the old name. The code, tests, and functionality are valid — only the naming is incorrect.
