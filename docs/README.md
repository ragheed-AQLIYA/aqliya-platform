...
| Document                           | Purpose                                                         |
| ---------------------------------- | --------------------------------------------------------------- |
| `DOCUMENTATION_INVENTORY.md`       | Full inventory of all documentation files                       |
| `DOCUMENTATION_GOVERNANCE.md`      | Hierarchy, authority rules, and immutable positioning           |
| `DOCUMENTATION_CONFLICT_REPORT.md` | Detectable conflicts between docs and official v1.1 positioning |
