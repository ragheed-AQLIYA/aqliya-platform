...
phase: "2 — Design (Pre-Implementation)"
version: "0.5"
date: 2026-06-28
author: OpenCode
classification: architecture-design
supersedes: "v0.4 (2026-06-28)"
adr: "ADR-RB02-001 through ADR-RB02-028 — see Appendix C"
---

# RB-02A — Authorization Model

> **Status:** ✅ **v1.0 Adopted (Normative Specification)** — This document is now at `docs/platform/authorization/RB-02A_AUTHORIZATION_MODEL.md` as the platform-wide authorization reference. The copy here is retained for program traceability. After acceptance, RB-02B may begin implementation following the Handoff Package (§12.8) and Execution Contract (§12).  
