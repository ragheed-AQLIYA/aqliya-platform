...
**Authority source:** `docs/products/auditos-sales-ops/crm-qualification-fields.md`, `docs/products/auditos-live-pilot-management/light-crm-import-format.md`  
**Spreadsheet template:** `docs/products/auditos-pilot-account-tracker-template.csv`  
**Execution index:** `docs/products/auditos-pilot-execution-index.md`  
...
Use the pilot scoring sheet (`docs/products/auditos-sales-ops/pilot-scoring-sheet.md`).
...
Use the CSV template for day-to-day tracking: `docs/products/auditos-pilot-account-tracker-template.csv` (all §1 fields + five placeholder rows).
...
Templates: `docs/products/auditos-outbound-kit/follow-up-templates.md`  
Operator playbook: `docs/products/auditos-pilot-operator-execution-guide.md` §5.
...
File: `docs/products/auditos-pilot-account-tracker-template.csv`
...
Manual intake SOP: `docs/products/auditos-pilot-manual-intake-fallback.md` §6.
...
| Document                  | Path                                                                            |
| ------------------------- | ------------------------------------------------------------------------------- |
| **Pilot Execution Index** | `docs/products/auditos-pilot-execution-index.md`                                 |
| Manual Intake Fallback    | `docs/products/auditos-pilot-manual-intake-fallback.md`                          |
| Intake Monitoring         | `docs/products/auditos-pilot-intake-monitoring.md`                               |
| CSV Template              | `docs/products/auditos-pilot-account-tracker-template.csv`                       |
...
| CRM Qualification Fields  | `docs/products/auditos-sales-ops/crm-qualification-fields.md`                    |
| Light CRM Import Format   | `docs/products/auditos-live-pilot-management/light-crm-import-format.md`         |
| Deal Stage Definitions    | `docs/products/auditos-sales-ops/deal-stage-definitions.md`                      |
| Pilot Scoring Sheet       | `docs/products/auditos-sales-ops/pilot-scoring-sheet.md`                         |
| Next Step Checklist       | `docs/products/auditos-sales-ops/next-step-checklist.md`                         |
| First 5 Customers Rules   | `docs/products/auditos-first-customer-loop/first-5-customers-operating-rules.md` |
