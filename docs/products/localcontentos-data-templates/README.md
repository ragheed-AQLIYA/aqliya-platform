...
**Depends on:** `docs/products/localcontentos-discovery-pack/`
...
| Pack                                          | Relationship                                                                      |
| --------------------------------------------- | --------------------------------------------------------------------------------- |
| `docs/products/localcontentos-discovery-pack/` | Product definition, workflow design, data requirements — foundation for templates |
| `docs/products/localcontentos-pilot-runbook/`  | Operating procedure that uses these templates during pilot execution              |
| `docs/products/localcontentos-sales-pack/`     | Commercial sales pack that references these templates in proposals                |
| `docs/products/localcontentos-mvp-spec/`       | Technical specification that translates these templates into data model entities  |
