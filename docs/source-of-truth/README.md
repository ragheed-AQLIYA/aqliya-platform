...
> **Status:** Level 4 — Supporting references. See `docs/DOCUMENTATION_AUTHORITY.md` for the documentation hierarchy.  
> These documents support architecture, taxonomy, route, and product status understanding. They are not the highest documentation authority.
