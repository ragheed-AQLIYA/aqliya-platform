...
**Phase 4 entry:** `docs/operations/phase-4-entry-checklist.md` (after Cycle 6 remote CLOSED). **Demo static gate:** `npm run demo:smoke` ✅ @ `7741c33`. **OAuth (L0-05 partial):** invite-only @ `62b7cb3` — see `sso-enterprise-decision.md`.
