...
**Phase 4 entry:** `docs/operations/phase-4-entry-checklist.md` (after Cycle 6 remote CLOSED). **Demo static gate:** `npm run demo:smoke` ✅ @ `7741c33` (slices 24–26 incl. sampling).
