...
3. `docs/product/auditos-product-packaging.md` — AuditOS pack
4. `docs/product/decisionos-product-definition-pack.md` — DecisionOS pack
5. `docs/product/governanceos-product-definition-pack.md` — GovernanceOS pack
6. `docs/product/simulationos-product-definition-pack.md` — SimulationOS pack
