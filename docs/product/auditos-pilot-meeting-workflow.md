...
**Authority source:** `docs/pilot/CLIENT-DEMO-SCRIPT.md`, `docs/product/auditos-outbound-kit/`, `docs/product/sombol-meeting-pack/`
...
Log in tracker objection sheet: `docs/product/auditos-pilot-account-tracker.md` §10.  
Weekly roll-up: `docs/product/auditos-pilot-command-center.md` §9.
...
If demo completed with interest: start evidence collection plan per `docs/product/auditos-pilot-proof-capture.md` §3.
...
| Discovery Questions      | `docs/product/auditos-outbound-kit/discovery-questions.md` |
| Follow-Up Templates      | `docs/product/auditos-outbound-kit/follow-up-templates.md` |
| Sombol Meeting Pack      | `docs/product/sombol-meeting-pack/`                        |
| Founder Pitch            | `docs/product/auditos-outbound-kit/founder-pitch.md`       |
