...
**Authority source:** `docs/product/auditos-live-pilot-management/pilot-evidence-checklist.md`, `docs/product/auditos-market-proof-system/proof-asset-index.md`, `docs/product/auditos-market-proof-system/proof-usage-rules.md`
...
| Proof Asset Index         | `docs/product/auditos-market-proof-system/proof-asset-index.md`                   |
| Proof Usage Rules         | `docs/product/auditos-market-proof-system/proof-usage-rules.md`                   |
| Case Study Capture        | `docs/product/auditos-live-pilot-management/first-customer-case-study-capture.md` |
| Case Study Publication    | `docs/product/auditos-market-proof-system/case-study-publication-workflow.md`     |
| Reference Account Program | `docs/product/auditos-market-proof-system/reference-account-program.md`           |
