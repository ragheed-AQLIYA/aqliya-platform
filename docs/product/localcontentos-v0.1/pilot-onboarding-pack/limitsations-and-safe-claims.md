...
| Binary PDF/XLSX export                                   | Current export is text/CSV. PDF/XLSX binary export is planned.                                  |
...
3. **During data discussion:** Explain that export is text/CSV, not binary PDF.
...
| "هل يطلع PDF؟"                       | التصدير الحالي CSV/نص. الـ PDF في خارطة الطريق.                        |
