...
| R-05 | Customer expects binary PDF/XLSX export                         | Disappointment when export is text/CSV             | Medium     | Mention limitation in demo; show the disclaimer content anyway; explain roadmap                                  | AQLIYA pilot lead     |
