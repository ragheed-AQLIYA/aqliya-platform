...
**Authority source:** `docs/products/auditos-first-customer-loop/pilot-command-center.md`, `docs/products/auditos-live-pilot-management/pilot-master-tracker.md`  
...
Field mapping from form to tracker: `docs/products/auditos-pilot-account-tracker.md` §8.

Full operator sequence: `docs/products/auditos-pilot-operator-execution-guide.md`.
...
Maintain register format in `docs/products/auditos-pilot-operator-execution-guide.md` §6.
...
| CSV Tracker Template         | `docs/products/auditos-pilot-account-tracker-template.csv`                 |
...
| Pilot Meeting Workflow       | `docs/products/auditos-pilot-meeting-workflow.md`                          |
...
| Weekly Founder Review        | `docs/products/auditos-first-customer-loop/weekly-founder-pilot-review.md` |
