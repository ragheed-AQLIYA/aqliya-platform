...
1. `docs/products/auditos-customer-conversion-reference/first-case-study-drafting-pack.md`
2. `docs/products/auditos-live-pilot-management/first-customer-case-study-capture.md`
3. `docs/products/auditos-customer-conversion-reference/reference-request-kit.md`
