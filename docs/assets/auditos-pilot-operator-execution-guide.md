...
**Authority source:** `docs/products/auditos-pilot-command-center.md`, `docs/products/auditos-pilot-account-tracker.md`  
...
Detail: `docs/products/auditos-pilot-proof-capture.md`
...
| Session Management Playbook | `docs/products/pilot-control-pack/auditos/10-session-management-playbook.md` |
| Pilot Operator Checklist    | `docs/products/pilot-control-pack/auditos/01-pilot-operator-checklist.md`    |
