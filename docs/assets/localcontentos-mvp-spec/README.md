...
**Version:** 1.0
**Depends on:** `docs/products/localcontentos-discovery-pack/`, `docs/products/localcontentos-data-templates/`, `docs/products/localcontentos-pilot-runbook/`, `docs/products/localcontentos-sales-pack/`
...
| Pack                                          | Relationship                                                               |
| --------------------------------------------- | -------------------------------------------------------------------------- |
| `docs/products/localcontentos-discovery-pack/` | Product definition, workflow, data requirements — foundation for this spec |
| `docs/products/localcontentos-data-templates/` | Field-level data specifications — translated into data model               |
| `docs/products/localcontentos-pilot-runbook/`  | Operating procedures — translated into workflow state machine              |
| `docs/products/localcontentos-sales-pack/`     | Commercial scope — translated into MVP features                            |
