...
| Review Eid build wave history          | [`../reports/eid-continuous-build-index-2026-05-28.md`](../evidence/reports/eid-continuous-build-index-2026-05-28.md) (waves 1–9 in [`../archive/old-reports/`](../archive/old-reports/README.md)) |
...
## Pilot Control Pack (`docs/products/pilot-control-pack/auditos/`)
...
| Deal stages                | `docs/products/auditos-sales-ops/deal-stage-definitions.md`                     |
...
| Pilot master tracker       | `docs/products/auditos-live-pilot-management/pilot-master-tracker.md`           |
| Pilot evidence checklist   | `docs/products/auditos-live-pilot-management/pilot-evidence-checklist.md`       |
| Weekly pilot status report | `docs/products/auditos-live-pilot-management/weekly-pilot-status-report.md`     |
| Demo → pilot handoff       | `docs/products/auditos-live-pilot-management/demo-to-pilot-handoff-template.md` |
...
| Customer journey timeline    | `docs/products/auditos-first-customer-loop/customer-journey-timeline.md`         |
| Weekly founder pilot review  | `docs/products/auditos-first-customer-loop/weekly-founder-pilot-review.md`       |
| Founder learning log         | `docs/products/auditos-first-customer-loop/founder-learning-log.md`              |
| Pilot → paid conversion memo | `docs/products/auditos-first-customer-loop/pilot-to-paid-conversion-memo.md`     |
...
- Eid Continuous Build index: `docs/evidence/reports/eid-continuous-build-index-2026-05-28.md`
