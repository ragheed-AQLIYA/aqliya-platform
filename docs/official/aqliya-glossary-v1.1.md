...
| **SalesOS**             | Governed commercial intelligence workspace at /sales/* (L6 Production-hardened). Pipeline, deals, accounts, ICP, intelligence, audit trail, seed data. See PRODUCT_STATUS_MATRIX.md for details.                                                                                                                                                                                                                                                               |
...
| **LocalContactOS**      | Governed relationship workspace at /contacts/* (L6 Production-hardened). Contact registry, sensitivity levels, interaction history, risk flags, compliance export, audit trail. See PRODUCT_STATUS_MATRIX.md for details.                                                                                                                                                                                                                                                                             |
| **ContentStudio**       | **Operational Content Workspace** — standalone governed platform for creating, reviewing, approving, publishing, and versioning institutional content. NOT a subsystem of LocalContentOS. Has its own Prisma models (ContentWorkspace, ContentItem, ContentVersion, ContentTemplate), 5 route groups, full lifecycle (DRAFT→IN_REVIEW→APPROVED→PUBLISHED→ARCHIVED), versioning, PDF export, audit trail, and ~125 tests. Current maturity: L6 Production-hardened (2026-07-03). See AQLIYA_SYSTEM_TAXONOMY.md for scope definition. |
...
| **RiskOS**              | AuditOS-adjacent risk workspace at /risk/* (L6 Production-hardened). Dashboard, assessment detail, procedure tracking, audit trail, JSON export. Not marketed as standalone product. See PRODUCT_STATUS_MATRIX.md for details.                                                                                                                                                                                                                                                                                                   |
...
| **Institutional Memory** | Cross-product entity linking workspace at /institutional-memory/* (L6 Production-hardened). Knowledge graph visualization, event linking, collections, export. See PRODUCT_STATUS_MATRIX.md for details.                                                                     |
