...
**Updated per:** DEC-2026-0008 (DecisionOS L5), DEC-2026-0009 (LocalContentOS L5) — Sprint v3 Governance Decisions  
...
| `/decisions/*`             | DecisionOS workspace                       | Active — L5 (DEC-2026-0008) |
| `/assistant/*`             | Office AI Assistant                        | Active — L4                 |
| `/local-content/*`         | LocalContentOS workspace (14 routes including review-center, quality-dashboard)       | Active — L5 (DEC-2026-0009) |
