...
- **LocalContentOS** — Pilot-ready with conditions / usable v0.1. Workspace, workflow, governance, evidence, review/approval, binary PDF/XLSX exports (pdfkit + xlsx), audit trail. Mutation feedback loop verified (2026-05-23). Pending: clean manual pass for review/approval/report inline forms; L6 hardening.
