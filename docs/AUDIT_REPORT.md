# AQLIYA AuditOS — Documentation Audit Report
...
**الوصف:**  
ستة ملفات في جذر `docs/` تشير إلى **"AQLIYA Decision OS"** — وهو منتج Tender Decisions القديم. هذه الملفات تجاور توثيق AuditOS وتخلق ارتباكًا شديدًا حول هوية AQLIYA.

**الملفات الملوثة:**

| File | Problem |
|------|---------|
| `DEMO.md` | عنوانه "# AQLIYA Decision OS - MVP Demo Guide" ويتحدث عن Tender Decision System |
| `DEMO_SCRIPT.md` | "# AQLIYA Decision OS - Demo Script" — نفس المشكلة |
| `DEMO_PITCH.md` | "# AQLIYA Decision OS - Demo Pitch" |
| `SALES_NARRATIVE.md` | "# AQLIYA Decision OS - Sales Narrative" |
| `CLIENT_WALKTHROUGH.md` | "# AQLIYA Decision OS - Client Walkthrough Guide" |
| `TECHNICAL_OVERVIEW.md` | "# AQLIYA Decision OS - Technical Overview" |
| `MVP_SCOPE.md` | "# AQLIYA Decision OS - MVP Scope" — يصف Decision, Simulation, Tender models |
