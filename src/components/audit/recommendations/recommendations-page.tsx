...
export default function RecommendationsPage() {
  ...
  const sorted = [...recommendations].sort(
    (a, b) => (riskValues[b.riskLevel] || 0) - (riskValues[a.riskLevel] || 0),
  );
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Button
            ...
            onClick={async () => {
              ...
              try {
                const r =
                  await generateRecommendationDraftsAction(engagementId);
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          const r = await acceptRecommendationDraftAction(
                            ai.id,
                            engagementId,
                          );
                          if (r.recommendation) {
                  ...
                  <>
                    ...
                    >
                      ...
                      <TableCell>
                        <Badge
                          variant="outline"
                          className={riskColors[rec.riskLevel]}
                        >
                          {rec.riskLevel}
                        </Badge>
                      </TableCell>
                                  ...
                                  <div className="flex items-center gap-1">
                                    <Button
                                      ...
                                      onClick={async (e) => {
                                        ...
                                        try {
                                          const r =
                                            await updateRecommendationStatusAction(
                                              rec.id,
                                              "accepted",
                                              engagementId,
                                            );
        ...
        {recHasMore && (
          <div className="flex justify-center py-3 border-t">
            <Button
              variant="outline"
              size="sm"
              disabled={loadingRecMore || generatingRecDrafts}
              onClick={async () => {
          ...
          <div className="space-y-3">
            <div>
              ...
              <Select
                ...
                onValueChange={(v) => {
                  if (v !== null) setNewRec({ ...newRec, findingId: v });
                }}
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setNewRec({ ...newRec, recommendedAction: e.target.value })
                }
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) => {
                  if (v !== null) setNewRec({ ...newRec, riskLevel: v });
                }}
              >
                <SelectTrigger>
                  <SelectValue />
