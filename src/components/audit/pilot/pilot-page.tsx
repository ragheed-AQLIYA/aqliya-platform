        ...
        >
          <CardContent className="p-3 sm:p-4 text-center">
            ...
            <div className="text-base sm:text-lg font-bold break-words">
              {openBlockers === 0
                ? t("ready")
                : `${openBlockers} ${t("blockers")}`}
            </div>
            <div className="text-[10px] text-muted-foreground break-words">
              {t("productionReadiness")}
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-3 sm:p-4 text-center">
            ...
            <div className="text-[10px] text-muted-foreground break-words">
              {t("feedbackItems")}{" "}
              {openFeedbacks > 0 ? `(${openFeedbacks} ${t("open")})` : ""}
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-3 sm:p-4 text-center">
            ...
            <div className="text-[10px] text-muted-foreground break-words">
              {t("blockersTitle")} ({openBlockers} {t("open")})
            </div>
          </CardContent>
        </Card>
              ...
              return (
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() => handleToggleSignoff(item)}
                  >
        ...
        <CardContent className="pt-3 px-3 sm:px-4">
          <div className="flex flex-wrap items-center gap-2 mb-3">
            <Select
              value={fbFilterCat}
              onValueChange={(v) => {
                if (v !== null) setFbFilterCat(v);
              }}
            >
              <SelectTrigger className="w-full sm:w-36">
                <SelectValue placeholder={t("categoryField")} />
              </SelectTrigger>
              <SelectContent>
            ...
            <Select
              ...
              onValueChange={(v) => {
                if (v !== null) setFbFilterStatus(v);
              }}
            >
              <SelectTrigger className="w-full sm:w-32">
                <SelectValue placeholder={t("statusField")} />
              </SelectTrigger>
              <SelectContent>
          ...
          {feedback.length === 0 ? (
            ...
            <div className="divide-y">
              {feedback
                .filter(
                  (f) => fbFilterCat === "all" || f.category === fbFilterCat,
                )
                .filter(
                  (f) =>
                    fbFilterStatus === "all" || f.status === fbFilterStatus,
                )
                .map((f) => (
                  <div key={f.id} className="py-2.5">
                    <div
                      ...
                      onClick={() =>
                        setFbExpanded(fbExpanded === f.id ? null : f.id)
                      }
                    >
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                          ...
                          <Badge
                            variant="outline"
                            className={`text-[10px] shrink-0 ${severityColors[f.severity] ?? ""}`}
                          >
                            {f.severity}
                          </Badge>
                          <Badge
                          ...
                          <Badge
                            variant="outline"
                            className={`text-[10px] shrink-0 ${statusColors[f.status] ?? ""}`}
                          >
                        ...
                        <div className="flex flex-wrap items-center gap-1">
                          {f.status === "open" && (
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                handleUpdateFeedbackStatus(f.id, "in_review")
                              }
                              className="text-[10px]"
                            >
                              {t("markInReview")}
                          ...
                          {f.status === "in_review" && (
                            <Button
                              ...
                              className="text-[10px]"
                              onClick={() =>
                                handleUpdateFeedbackStatus(f.id, "accepted")
                              }
                            >
                              {t("accept")}
                            </Button>
                          ...
                          {(f.status === "open" ||
                            ...
                            <Button
                              ...
                              className="text-[10px]"
                              onClick={() =>
                                handleUpdateFeedbackStatus(f.id, "dismissed")
                              }
                            >
                              {t("dismiss")}
                            </Button>
                          ...
                          {f.status === "accepted" && (
                            <Button
                              ...
                              className="text-[10px]"
                              onClick={() =>
                                handleUpdateFeedbackStatus(f.id, "resolved")
                              }
                            >
                              {t("markResolved")}
                            </Button>
              ...
              {blockers.map((b) => (
                <div key={b.id} className="py-2.5">
                  <div
                    className="flex items-start justify-between cursor-pointer gap-2"
                    onClick={() =>
                      setBlockerExpanded(blockerExpanded === b.id ? null : b.id)
                    }
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                      ...
                      <div className="flex flex-wrap items-center gap-1">
                        {b.status === "open" && (
                          <Button
                            ...
                            className="text-[10px]"
                            onClick={() =>
                              handleUpdateBlockerStatus(b.id, "in_progress")
                            }
                          >
                            {t("inProgress")}
                          </Button>
                        ...
                        {b.status === "in_progress" && (
                          <Button
                            ...
                            className="text-[10px]"
                            onClick={() =>
                              handleUpdateBlockerStatus(b.id, "resolved")
                            }
                          >
                            {t("resolve")}
                          </Button>
      ...
      <Dialog open={showFeedbackDialog} onOpenChange={setShowFeedbackDialog}>
        <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <div>
              <Label>{t("sourceField")}</Label>
              <Input
                value={newFeedback.source}
                onChange={(e) =>
                  setNewFeedback({ ...newFeedback, source: e.target.value })
                }
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) => {
                  if (v !== null)
                    setNewFeedback({ ...newFeedback, category: v });
                }}
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) => {
                  if (v !== null)
                    setNewFeedback({ ...newFeedback, severity: v });
                }}
              >
                <SelectTrigger>
                  <SelectValue />
          ...
          <DialogFooter>
            ...
            <Button
              disabled={!newFeedback.title.trim() || fbSubmitting}
              onClick={handleCreateFeedback}
            >
              {fbSubmitting ? t("saving") : t("saveFeedback")}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
