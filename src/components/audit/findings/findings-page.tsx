...
export default function FindingsPage() {
  ...
  const [showLinkedEvidence, setShowLinkedEvidence] = useState<Finding | null>(
    null,
  );
  ...
  return (
    <div className="space-y-6" dir="rtl">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          const r = await acceptFindingDraftAction(
                            ai.id,
                            engagementId,
                          );
                          if (r.finding) {
                        ...
                        <TableCell colSpan={7} className="bg-muted/30">
                          <div className="p-4 space-y-3 text-sm">
                            ...
                            <div className="flex items-center gap-4 text-xs text-muted-foreground">
                              <span>
                                {t("materiality", {
                                  value: finding.materiality ?? "",
                                })}
                              </span>
                              {finding.assignedTo && (
                                <span>
                                  {t("assignedTo", {
                                    name: finding.assignedTo ?? "",
                                  })}
                                </span>
                              )}
                              <span>
                            ...
                            <div className="flex gap-2 pt-1 flex-wrap">
                              ...
                              <Button
                                ...
                                onClick={async (e) => {
                                  ...
                                  try {
                                    const ev =
                                      await getEvidenceAction(engagementId);
                                    const linked = ev.filter((e) =>
                                      e.linkedEntities.some(
                                        (le) =>
                                          le.targetId === finding.id ||
                                          le.targetType === "finding",
                                      ),
                                    );
      ...
      <Dialog
        open={!!showLinkedEvidence}
        onOpenChange={() => setShowLinkedEvidence(null)}
      >
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {t("linkedEvidenceDescription", {
                title: showLinkedEvidence?.title ?? "",
              })}
            </DialogDescription>
          </DialogHeader>
          {loadingLinked ? (
      ...
      <Dialog
        open={!!showLinkedRecs}
        onOpenChange={() => setShowLinkedRecs(null)}
      >
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) => {
                    if (v !== null) {
                      setNewFinding({ ...newFinding, findingType: v });
                    }
                  }}
                >
                  <SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewFinding({ ...newFinding, rootCause: e.target.value })
                }
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!newFinding.title.trim() || createSubmitting}
            >
