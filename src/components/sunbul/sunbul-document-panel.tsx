...
import {
  sunbul_listDocuments,
  sunbul_deleteDocument,
} from "@/actions/sunbul-actions";
import { SunbulAddDocumentForm } from "@/components/sunbul/sunbul-add-document-form";
import {
  Loader2,
  FileText,
  Trash2,
...
export function SunbulDocumentPanel({
  clientId,
  recordId,
  recordStatus,
  userRole,
  ...
  async function handleDelete(documentId: string) {
    ...
    await sunbul_deleteDocument(clientId, recordId, documentId);
    setDeleting(null);
    setRefreshKey((k) => k + 1);
  }
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-0.5 flex items-center gap-3 text-[10px] text-muted-foreground">
                    ...
                    {doc.storageKey.startsWith("metadata-only:") ? (
                      ...
                      <a
                        href={`/api/sunbul/documents/${doc.id}/download`}
