...
import { sunbul_uploadDocument } from "@/actions/sunbul-actions";
import { Loader2, Plus, Upload } from "lucide-react";

export function SunbulAddDocumentForm({
  clientId,
  recordId,
  recordStatus,
  userRole,
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const result = await sunbul_uploadDocument(clientId, recordId, {
        fileName: file.name,
