...
import type {
  Organization, AuditUser, Client, Engagement, TrialBalance, TrialBalanceLine,
  CanonicalAccount, AccountMapping, ValidationRun, ValidationIssue,
...
export const mockUsers: AuditUser[] = [
  { id: ID.PARTNER, organizationId: ID.ORG, email: 'khalid@aqliya.sa', name: 'Khalid Al Saud', role: 'partner', status: 'active', createdAt: '2025-01-01T00:00:00Z' },
  { id: ID.MANAGER, organizationId: ID.ORG, email: 'farida@aqliya.sa', name: 'Farida Al Zamil', role: 'manager', status: 'active', createdAt: '2025-01-01T00:00:00Z' },
  { id: ID.REVIEWER, organizationId: ID.ORG, email: 'sarah@aqliya.sa', name: 'Sarah Al Otaibi', role: 'reviewer', status: 'active', createdAt: '2025-01-01T00:00:00Z' },
  { id: ID.OPERATOR, organizationId: ID.ORG, email: 'ahmed@aqliya.sa', name: 'Ahmed Al Ghamdi', role: 'operator', status: 'active', createdAt: '2025-01-01T00:00:00Z' },
  { id: ID.VIEWER, organizationId: ID.ORG, email: 'client@gulf-trading.sa', name: 'Faisal Al Harbi', role: 'viewer', status: 'active', createdAt: '2025-01-01T00:00:00Z' },
  { id: ID.ADMIN, organizationId: ID.ORG, email: 'admin@aqliya.sa', name: 'Admin User', role: 'admin', status: 'active', createdAt: '2025-01-01T00:00:00Z' },
]
...
export const mockTeam: EngagementTeamMember[] = [
  { userId: ID.PARTNER, userName: 'Khalid Al Saud', role: 'partner', assignedAt: '2025-03-01T00:00:00Z' },
  { userId: ID.MANAGER, userName: 'Farida Al Zamil', role: 'manager', assignedAt: '2025-03-01T00:00:00Z' },
  { userId: ID.REVIEWER, userName: 'Sarah Al Otaibi', role: 'reviewer', assignedAt: '2025-03-02T00:00:00Z' },
  { userId: ID.OPERATOR, userName: 'Ahmed Al Ghamdi', role: 'operator', assignedAt: '2025-03-02T00:00:00Z' },
]
...
export const mockTBLines: TrialBalanceLine[] = [
  ...
  { id: 'tb-line-3', trialBalanceId: ID.TB, accountCode: '1030', accountName: 'Inventory', debitAmount: SAR(800000), creditAmount: 0, balance: SAR(800000), accountType: 'asset', currency: 'SAR' },
  { id: 'tb-line-4', trialBalanceId: ID.TB, accountCode: '1040', accountName: 'Prepayments', debitAmount: SAR(75000), creditAmount: 0, balance: SAR(75000), accountType: 'asset', currency: 'SAR' },
...
export const mockCanonicalAccounts: CanonicalAccount[] = [
  { id: 'ca-1', code: 'CA-1010', name: 'Cash and Cash Equivalents', category: 'Current Assets', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 100 },
  { id: 'ca-2', code: 'CA-1020', name: 'Trade Receivables', category: 'Current Assets', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 110 },
  { id: 'ca-3', code: 'CA-1030', name: 'Inventories', category: 'Current Assets', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 120 },
  { id: 'ca-4', code: 'CA-1040', name: 'Prepayments', category: 'Current Assets', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 130 },
  { id: 'ca-5', code: 'CA-1050', name: 'Property, Plant and Equipment', category: 'Non-Current Assets', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 200 },
  { id: 'ca-6', code: 'CA-1060', name: 'Accumulated Depreciation', category: 'Non-Current Assets', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 210 },
  { id: 'ca-7', code: 'CA-2010', name: 'Trade Payables', category: 'Current Liabilities', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 300 },
  { id: 'ca-8', code: 'CA-2020', name: 'Accrued Expenses', category: 'Current Liabilities', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 310 },
  { id: 'ca-9', code: 'CA-2030', name: 'Tax and Zakat Payable', category: 'Current Liabilities', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 320 },
  { id: 'ca-10', code: 'CA-2040', name: 'Short-term Borrowings', category: 'Current Liabilities', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 330 },
  { id: 'ca-11', code: 'CA-3010', name: 'Share Capital', category: 'Equity', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 400 },
  { id: 'ca-12', code: 'CA-3020', name: 'Retained Earnings', category: 'Equity', statementType: 'balance_sheet', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 410 },
  { id: 'ca-13', code: 'CA-4010', name: 'Revenue - Sale of Goods', category: 'Revenue', statementType: 'income_statement', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 500 },
  { id: 'ca-14', code: 'CA-4020', name: 'Revenue - Services', category: 'Revenue', statementType: 'income_statement', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 510 },
  { id: 'ca-15', code: 'CA-5010', name: 'Cost of Sales', category: 'Expenses', statementType: 'income_statement', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 600 },
  { id: 'ca-16', code: 'CA-5020', name: 'Employee Benefits', category: 'Expenses', statementType: 'income_statement', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 610 },
  { id: 'ca-17', code: 'CA-5030', name: 'Occupancy Expenses', category: 'Expenses', statementType: 'income_statement', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 620 },
  { id: 'ca-18', code: 'CA-5040', name: 'Utilities', category: 'Expenses', statementType: 'income_statement', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 630 },
  { id: 'ca-19', code: 'CA-5050', name: 'Depreciation and Amortisation', category: 'Expenses', statementType: 'income_statement', reportingFramework: 'ifrs_for_smes', version: '1.0', displayOrder: 640 },
...
export const mockMappings: AccountMapping[] = [
  { id: 'map-1', engagementId: ID.ENG, sourceAccountId: 'tb-line-1', sourceAccountCode: '1010', sourceAccountName: 'Cash and Bank', debitAmount: SAR(500000), creditAmount: 0, canonicalAccountId: 'ca-1', canonicalAccountCode: 'CA-1010', canonicalAccountName: 'Cash and Cash Equivalents', statementClassification: 'Current Assets', confidence: 0.98, mappingType: 'confirmed_ai', status: 'confirmed', mappedBy: 'Ahmed Al Ghamdi', mappedAt: '2025-04-15T11:00:00Z', updatedAt: '2025-04-15T11:00:00Z' },
  { id: 'map-2', engagementId: ID.ENG, sourceAccountId: 'tb-line-2', sourceAccountCode: '1020', sourceAccountName: 'Accounts Receivable', debitAmount: SAR(1200000), creditAmount: 0, canonicalAccountId: 'ca-2', canonicalAccountName: 'Trade Receivables', confidence: 0.97, mappingType: 'confirmed_ai', status: 'confirmed', mappedBy: 'Ahmed Al Ghamdi', mappedAt: '2025-04-15T11:05:00Z', updatedAt: '2025-04-15T11:05:00Z' },
  { id: 'map-3', engagementId: ID.ENG, sourceAccountId: 'tb-line-3', sourceAccountCode: '1030', sourceAccountName: 'Inventory', debitAmount: SAR(800000), creditAmount: 0, canonicalAccountId: 'ca-3', canonicalAccountName: 'Inventories', confidence: 0.99, mappingType: 'confirmed_ai', status: 'confirmed', mappedBy: 'Ahmed Al Ghamdi', mappedAt: '2025-04-15T11:10:00Z', updatedAt: '2025-04-15T11:10:00Z' },
  { id: 'map-4', engagementId: ID.ENG, sourceAccountId: 'tb-line-4', sourceAccountCode: '1040', sourceAccountName: 'Prepayments', debitAmount: SAR(75000), creditAmount: 0, canonicalAccountId: 'ca-4', canonicalAccountName: 'Prepayments', confidence: 0.96, mappingType: 'ai_suggested', status: 'confirmed', mappedBy: 'Ahmed Al Ghamdi', mappedAt: '2025-04-15T11:15:00Z', updatedAt: '2025-04-15T11:15:00Z' },
  ...
  { id: 'map-16', engagementId: ID.ENG, sourceAccountId: 'tb-line-16', sourceAccountCode: '5020', sourceAccountName: 'Salaries and Wages', debitAmount: SAR(900000), creditAmount: 0, canonicalAccountId: 'ca-16', canonicalAccountName: 'Employee Benefits', confidence: 0.96, mappingType: 'human_mapped', status: 'confirmed', mappedBy: 'Ahmed Al Ghamdi', mappedAt: '2025-04-15T12:15:00Z', updatedAt: '2025-04-15T12:15:00Z' },
  { id: 'map-17', engagementId: ID.ENG, sourceAccountId: 'tb-line-17', sourceAccountCode: '5030', sourceAccountName: 'Rent Expense', debitAmount: SAR(240000), creditAmount: 0, canonicalAccountId: 'ca-17', canonicalAccountName: 'Occupancy Expenses', confidence: 0.95, mappingType: 'ai_suggested', status: 'confirmed', mappedBy: 'Ahmed Al Ghamdi', mappedAt: '2025-04-15T12:20:00Z', updatedAt: '2025-04-15T12:20:00Z' },
...
export const mockFinancialStatements: FinancialStatement[] = [
  {
    id: 'fs-is-1', engagementId: ID.ENG, statementType: 'income_statement', title: 'Statement of Profit or Loss',
    status: 'draft', lines: incomeStatementLines, linkedAccounts: mockMappings, reviewComments: [], createdAt: '2025-04-16T09:00:00Z', updatedAt: '2025-04-16T09:00:00Z',
  },
  {
    id: 'fs-bs-1', engagementId: ID.ENG, statementType: 'balance_sheet', title: 'Statement of Financial Position',
    status: 'draft', lines: balanceSheetLines, linkedAccounts: mockMappings, reviewComments: [], createdAt: '2025-04-16T09:00:00Z', updatedAt: '2025-04-16T09:00:00Z',
  },
]
...
export const mockEvidence: EvidenceObject[] = [
  { id: 'ev-1', engagementId: ID.ENG, filename: 'gulf_trading_tb_fy2025.xlsx', fileType: 'xlsx', fileSize: 245000, fileHash: 'hash-001', uploadedBy: 'Ahmed Al Ghamdi', uploadedAt: '2025-04-15T10:30:00Z', state: 'accepted', linkedEntities: [{ id: 'el-1', evidenceId: 'ev-1', targetType: 'account', targetId: 'all', targetLabel: 'All Accounts', linkType: 'supports', createdBy: 'Ahmed Al Ghamdi', createdAt: '2025-04-15T10:30:00Z' }], storageKey: 'tb-files/gulf_trading_tb_fy2025.xlsx' },
  { id: 'ev-2', engagementId: ID.ENG, filename: 'bank_confirmation_samba.pdf', fileType: 'pdf', fileSize: 180000, fileHash: 'hash-002', uploadedBy: 'Ahmed Al Ghamdi', uploadedAt: '2025-04-20T09:00:00Z', state: 'accepted', linkedEntities: [{ id: 'el-2', evidenceId: 'ev-2', targetType: 'account', targetId: 'tb-line-1', targetLabel: 'Cash and Bank', linkType: 'supports', createdBy: 'Ahmed Al Ghamdi', createdAt: '2025-04-20T09:05:00Z' }], storageKey: 'evidence/bank_confirmation_samba.pdf' },
  { id: 'ev-3', engagementId: ID.ENG, filename: 'ar_aging_report.pdf', fileType: 'pdf', fileSize: 320000, fileHash: 'hash-003', uploadedBy: 'Sarah Al Otaibi', uploadedAt: '2025-04-22T14:00:00Z', state: 'accepted', linkedEntities: [{ id: 'el-3', evidenceId: 'ev-3', targetType: 'account', targetId: 'tb-line-2', targetLabel: 'Accounts Receivable', linkType: 'supports', createdBy: 'Sarah Al Otaibi', createdAt: '2025-04-22T14:05:00Z' }], storageKey: 'evidence/ar_aging_report.pdf' },
  { id: 'ev-4', engagementId: ID.ENG, filename: 'ppe_schedule.xlsx', fileType: 'xlsx', fileSize: 95000, fileHash: 'hash-004', uploadedBy: 'Ahmed Al Ghamdi', uploadedAt: '2025-04-25T11:00:00Z', state: 'accepted', linkedEntities: [{ id: 'el-4', evidenceId: 'ev-4', targetType: 'account', targetId: 'tb-line-5', targetLabel: 'Property and Equipment', linkType: 'supports', createdBy: 'Ahmed Al Ghamdi', createdAt: '2025-04-25T11:05:00Z' }], storageKey: 'evidence/ppe_schedule.xlsx' },
  { id: 'ev-5', engagementId: ID.ENG, filename: 'loan_agreement.pdf', fileType: 'pdf', fileSize: 450000, fileHash: 'hash-005', uploadedBy: 'Sarah Al Otaibi', uploadedAt: '2025-04-28T10:00:00Z', state: 'reviewed', linkedEntities: [{ id: 'el-5', evidenceId: 'ev-5', targetType: 'account', targetId: 'tb-line-10', targetLabel: 'Short-term Loan', linkType: 'supports', createdBy: 'Sarah Al Otaibi', createdAt: '2025-04-28T10:05:00Z' }], storageKey: 'evidence/loan_agreement.pdf' },
  // Missing evidence placeholder
  { id: 'ev-missing-1', engagementId: ID.ENG, filename: 'inventory_count_sheet.pdf', fileType: 'pdf', fileSize: 0, fileHash: '', uploadedBy: '', uploadedAt: '', state: 'missing', linkedEntities: [{ id: 'el-m1', evidenceId: 'ev-missing-1', targetType: 'account', targetId: 'tb-line-3', targetLabel: 'Inventory', linkType: 'supports', createdBy: 'System', createdAt: '2025-04-16T00:00:00Z' }], storageKey: '' },
]
...
export const mockFindings: Finding[] = [
  ...
  {
    id: 'find-2', engagementId: ID.ENG, title: 'Short-term Loan Classification',
    findingType: 'disclosure_gap', severity: 'high', materiality: 'material',
    description: 'Short-term Loan (account 2040) of SAR 500,000 is classified as current, but the loan agreement indicates a 24-month term. This may require reclassification as non-current.',
    rootCause: 'Classification error in trial balance preparation', impact: 'Current ratio and working capital presentation',
    status: 'open', relatedAccountIds: ['tb-line-10'], relatedEvidenceIds: ['ev-5'], aiSuggested: true,
    createdAt: '2025-04-22T10:00:00Z', updatedAt: '2025-04-22T10:00:00Z',
  },
  {
    id: 'find-3', engagementId: ID.ENG, title: 'Missing Inventory Evidence',
    findingType: 'disclosure_gap', severity: 'high', materiality: 'material',
    description: 'Inventory of SAR 800,000 (account 1030) has no supporting evidence. Physical inventory count sheet has not been uploaded.',
    rootCause: 'Pending client submission', impact: 'Cannot verify existence of inventory',
    status: 'in_review', relatedAccountIds: ['tb-line-3'], relatedEvidenceIds: [], aiSuggested: false,
    assignedTo: 'client@gulf-trading.sa',
    createdAt: '2025-04-23T09:00:00Z', updatedAt: '2025-04-23T09:00:00Z',
  },
  {
    id: 'find-4', engagementId: ID.ENG, title: 'Professional Fees Variance',
...
export const mockRecommendations: Recommendation[] = [
  ...
  {
    id: 'rec-2', engagementId: ID.ENG, findingId: 'find-2', title: 'Reclassify Short-term Loan as Non-Current',
    description: 'Reclassify SAR 500,000 Short-term Loan from current to non-current liabilities based on 24-month term.',
    recommendedAction: 'Reclassify the Short-term Loan to Non-current Borrowings. Disclose the reclassification in the notes. Verify loan agreement terms.',
    impactAssessment: 'Improves current ratio. Provides more accurate presentation of liquidity.',
    riskLevel: 'high', status: 'under_review', aiContributed: true,
    createdAt: '2025-04-25T08:30:00Z', updatedAt: '2025-04-25T08:30:00Z',
  },
  {
    id: 'rec-3', engagementId: ID.ENG, findingId: 'find-3', title: 'Request Inventory Count Sheet from Client',
    description: 'Client must provide physical inventory count sheet and valuation report.',
    recommendedAction: 'Send formal evidence request to Gulf Trading Co. for: (1) Physical inventory count sheet with signatures, (2) Inventory valuation report, (3) NRV assessment for slow-moving items.',
    impactAssessment: 'Required to verify existence and valuation of SAR 800,000 inventory balance.',
    riskLevel: 'high', status: 'suggested', aiContributed: false,
    createdAt: '2025-04-25T09:00:00Z', updatedAt: '2025-04-25T09:00:00Z',
  },
]
...
export const mockReviewComments: ReviewComment[] = [
  ...
  {
    id: 'rc-2', engagementId: ID.ENG, targetType: 'note', targetId: 'note-2',
    reviewerId: ID.REVIEWER, reviewerName: 'Sarah Al Otaibi',
    comment: 'PPE note needs depreciation rates per asset class and details of additions/disposals during the year.',
    requiredAction: 'provide_evidence', status: 'open',
    createdAt: '2025-04-28T14:30:00Z',
...
export const mockApprovalRecords: ApprovalRecord[] = [
  {
    id: 'appr-1', engagementId: ID.ENG, approverId: ID.MANAGER, approverName: 'Farida Al Zamil',
    approverRole: 'manager', action: 'approved', rationale: 'Preliminary mapping review complete. Proceed to evidence collection.',
    targetType: 'engagement', targetId: ID.ENG,
...
export const mockAuditEvents: AuditEvent[] = [
  ...
  // Most recent events
  { id: 'ae-15', engagementId: ID.ENG, eventType: 'finding.state_changed', actorId: ID.REVIEWER, actorName: 'Sarah Al Otaibi', actorRole: 'reviewer', targetType: 'finding', targetId: 'find-3', previousState: 'open', newState: 'in_review', description: 'Finding "Missing Inventory Evidence" moved to In Review', aiRelated: false, timestamp: '2025-05-01T10:00:00Z' },
  { id: 'ae-16', engagementId: ID.ENG, eventType: 'recommendation.state_changed', actorId: ID.REVIEWER, actorName: 'Sarah Al Otaibi', actorRole: 'reviewer', targetType: 'recommendation', targetId: 'rec-2', previousState: 'suggested', newState: 'under_review', description: 'Recommendation "Reclassify Loan" moved to Under Review', aiRelated: false, timestamp: '2025-05-02T09:00:00Z' },
]
...
export const mockDashboardSummary: DashboardSummary = {
  ...
  engagements: [
    mockEngagement,
    {
      ...mockEngagement, id: 'eng-2', clientId: 'cli-2',
      client: { ...mockClient, id: 'cli-2', name: 'Saudi Logistics Co.' },
      fiscalPeriod: 'FY2025', status: 'setup', team: mockTeam, alerts: [], createdAt: '2025-04-01T00:00:00Z', updatedAt: '2025-04-01T00:00:00Z',
    },
    {
      ...mockEngagement, id: 'eng-3', clientId: 'cli-3',
      client: { ...mockClient, id: 'cli-3', name: 'Red Sea Construction Co.', industry: 'Construction' },
      fiscalPeriod: 'FY2025', status: 'awaiting_client', team: mockTeam, alerts: [], createdAt: '2025-03-15T00:00:00Z', updatedAt: '2025-04-20T00:00:00Z',
    },
  ],
}
