 ...
 *
 * Moved from src/lib/core/ai/handlers/ → src/lib/audit/handlers/
 * per ADR-003 (Platform Neutrality) — product-specific handlers belong
 * in product directories, not in Core.
 */

import type { DeterministicTaskHandler, AIResponse } from "@/lib/core/ai/types";
