  ...
  async assessRisk(
    ...
    const assessment = await prisma.clientRiskAssessment.upsert({
      ...
      create: {
        ...
        mitigatingFactors: ((input.mitigatingFactors ?? []) as unknown) as Prisma.InputJsonValue,
  ...
  async createContinuanceReview(
    ...
    return prisma.continuanceReview.create({
      data: {
        ...
        engagementHistory: (input.engagementHistory as unknown) as Prisma.InputJsonValue,
        feeHistory: (input.feeHistory as unknown) as Prisma.InputJsonValue,
        clientChanges: (input.clientChanges as unknown) as Prisma.InputJsonValue,
        createdById: actor.actorId,
      },
    });
  }
