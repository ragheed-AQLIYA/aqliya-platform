...
export const buyerJourneys: BuyerJourney[] = [
  {
    ...
    secondaryCta: { label: "كيف نعمل", href: "/start#process" },
  },
  {
    id: "cfo",
    label: "المدير المالي",
    ...
    steps: [
      { label: "دليل المدير المالي", href: "/start#cfo", time: "١٠ دقائق" },
  ...
  },
  {
    ...
    steps: [
      ...
      { label: "دليل CIO", href: "/start#cio", time: "١٢ دقيقة" },
    ],
  ...
  },
  {
    ...
    steps: [
      { label: "دليل شريك التدقيق", href: "/start#audit", time: "١٠ دقائق" },
  ...
  },
  {
    ...
    steps: [
      ...
      { label: "نماذج التعاون", href: "/start#engagement", time: "١٠ دقائق" },
  ...
  },
  {
    ...
    steps: [
      { label: "دليل الجهات الحكومية", href: "/start#government", time: "١٢ دقيقة" },
      { label: "LocalContentOS", href: "/products/local-content", time: "٨ دقائق" },
...
export const universalJourneySteps: BuyerJourneyStep[] = [
  ...
  { label: "قرار بالأدلة", href: "/start#engagement", time: "جلسة واحدة" },
  { label: "تفعيل", href: "/start#process", time: "حسب النطاق" },
];
