...
export async function createOutput(input: CreateOutputPackageInput): Promise<OutputPackage> {
...
export async function listOutputs(organizationId: string): Promise<OutputPackage[]> {
...
export async function getOutput(id: string, organizationId: string): Promise<OutputPackage | null> {
