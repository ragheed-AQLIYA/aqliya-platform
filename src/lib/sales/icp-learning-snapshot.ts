// SalesOS ICP learning snapshot — shared between v02 and vnext
...
const WIN_LOSS_REASON_AR: Record<string, string> = {
  ...
  competitor: "منافس أقوى",
  timing: "توقيت غير مناسب",
  pricing: "تسعير تنافسي",
  governance: "متطلبات حوكمة",
  security: "متطلبات أمنية",
  complexity: "تعقيد التنفيذ",
  loss_debrief: "خسارة لأسباب أخرى",
};
