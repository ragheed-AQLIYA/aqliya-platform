...
// Moved from src/lib/platform/signals/ per ADR-003 (Platform Neutrality)
...
import type { ProductMetricSignals, RuntimeSignal } from "@/lib/platform/signals/types";
  ...
  return opportunities
    .filter(
      (o) =>
        ...
        o.reviewStatus === "InReview" || o.stage === "Qualification",
    )
    .map((o) => ({
      id: `opp-${o.id}`,
      organizationId,
