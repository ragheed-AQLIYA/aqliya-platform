...
const personas = [
  ...
  },
  {
    ...
    answers: [
      ...
      "البايلوت يعمل مستقلًا — استيراد CSV/XLSX، تصدير JSON/XLSX. API خارجي وتكامل ERP في خارطة ما بعد الإنتاج.",
      "النموذج الحالي: Cloud Managed Deployment. نموذج Private Cloud قيد التخطيط. البايلوت في بيئة محكومة متفق عليها.",
  ...
  },
  {
    ...
    answers: [
      ...
      "نحن في مرحلة Pilot-ready. المراجعة الأمنية الخارجية من متطلبات ما قبل الإنتاج. نوفر الوثائق للمراجعة.",
  ...
  },
  {
    ...
    questions: [
      ...
      "ما هي معايير التقييم المقترحة لقياس نجاح البايلوت؟",
      "كيف أحصل على عرض رسمي مع نطاق وتسعيرة واضحة؟",
    ],
    answers: [
      "6 وثائق متاحة: نطاق البايلوت، الإفصاح عن المخاطر، مواصفات النشر، مصفوفة الصلاحيات، معايير النجاح، خطة التوسع.",
      "4 نماذج: التشخيص التنفيذي (مجاني)، بايلوت تقييمي (مجاني)، نشر المنتج، نظام مؤسسي مخصص.",
      "28 معيار قابل للقياس — شروط Go/No-Go واضحة وآلية تقييم مستقل قبل أي التزام اشتراك.",
      "تواصل معنا لتلقي حزمة وثائق التقييم الكاملة وجدولة الجلسة التنفيذية.",
    ],
    outputs: [],
    ctas: [
      { label: "طلب حزمة التقييم", href: "/contact", primary: true },
  ...
  return (
    <div className="flex flex-col gap-20 sm:gap-28" dir="rtl">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <EnterpriseCTA
          title="بدأ الرحلة"
          description="اختر مسارك: جلسة تنفيذية لفريقك القيادي، ديمو موجّه لمدة ٤ دقائق، أو بايلوت تقييمي مجاني لمدة ٢-٤ أسابيع."
