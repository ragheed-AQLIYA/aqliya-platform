...
const deploymentModels = [
  ...
  },
  {
    ...
    description:
      "بيئة تشغيل منفصلة تماماً عن الإنترنت، مخصصة لأشد البيئات حساسية — سواء حكومية أو دفاعية أو تنظيمية. ليست نظاماً جاهزاً للتفعيل حالياً.",
    features: [
      ...
      { label: "التوفر الحالي", value: "غير متاح كنظام جاهز للتفعيل" },
    ],
    bestFor: [
