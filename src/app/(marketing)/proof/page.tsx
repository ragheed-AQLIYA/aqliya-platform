...
export const metadata: Metadata = {
  ...
  description:
    "ديمو تفاعلي، إطار بايلوت، مكتبة مخرجات، وملخص أمن — كل ما تحتاجه لتقييم عقلية قبل أي قرار.",
};
...
const proofSections = [
  ...
  },
  {
    ...
    body: "ما هي عقلية، لماذا تهم مؤسستك، ما الجاهز للتجربة، وما ليس متاحاً بعد — بصدق كامل.",
  ...
  },
  {
    ...
    body: "ستة أبعاد تقييم، معايير Go/No-Go، وأمثلة أدلة تُلتقط أثناء التجربة — قبل أي التزام.",
    href: "/pilot-proof",
    cta: "إطار إثبات البايلوت",
  },
  {
    id: "evidence-library",
    title: "مكتبة الأدلة",
  ...
  },
  {
    ...
    subtitle: "مقاييس حقيقية — عند الجاهزية",
    body: "لا أرقام وهمية. صفحة placeholder تُحدّث عند ≥2 بايلوت مكتمل مع Go/No-Go.",
    href: "/pilot-outcomes",
    cta: "نتائج البايلوت",
  },
  {
    ...
    body: "ملخص تنفيذي، ملخص أمن، إطار بايلوت، ونماذج تعاون — جاهزة لفريق المشتريات.",
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-16 sm:py-22">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-lg leading-8 text-white/60">
              ...
              وثائق، معايير بايلوت، وأمن — في مكان واحد.
            </p>
