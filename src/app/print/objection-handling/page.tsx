...
const objections = [
  ...
  {
    q: "أحببنا التقييم لكن غير جاهزين للدفع",
    a: "متابعة بأضيق نطاق، مرجع anonymized، أو تمديد محدد لإثبات نقطة واحدة — لا ضغط.",
  },
  {
    q: "نحتاج المزيد من الإثبات",
    a: "ديمو + تقييم تشغيلي مجاني محدود + قرار بالأدلة مكتوب — لا عقد واسع قبل ذلك.",
  },
];
