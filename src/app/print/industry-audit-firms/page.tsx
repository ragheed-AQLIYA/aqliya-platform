  ...
  return (
    <>
      ...
      <article className="print-doc" dir="rtl">
        ...
        <p>
          ديمو تفاعلي (10 دقائق) → جلسة تشخيص (45 دقيقة) → بايلوت مجاني
          على ارتباط واحد → Go/No-Go → نشر مدفوع.
        </p>
        ...
        <ul>
          ...
          <li>CaseWare/ERP replacement كامل في بايلوت واحد</li>
        </ul>
