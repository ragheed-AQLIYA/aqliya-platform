...
export default function DecisionsError({
  ...
  useEffect(() => {
    clientLogger.error("[DecisionOS Error Boundary]", error);
  }, [error]);
        ...
        <CardContent className="flex flex-col items-center justify-center space-y-4 p-8 text-center">
          ...
          <div className="space-y-1">
            <h2 className="text-lg font-semibold">
              تعذر تحميل مساحة DecisionOS
            </h2>
            <p className="max-w-md text-sm text-muted-foreground">
              حدث خطأ أثناء تحميل مسار القرار. يمكنك إعادة المحاولة أو العودة
              إلى قائمة القرارات دون فقدان البيانات المحفوظة.
            </p>
          </div>
          <div className="flex gap-2">
            ...
            <Link href="/decisions">
              <Button size="sm">العودة للقرارات</Button>
            </Link>
          </div>
        </CardContent>
      </Card>
