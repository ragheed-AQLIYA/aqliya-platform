...
const mockRecentEntities = [
  {
    ...
    title: "قرار الاستثمار للربع الثالث",
    status: "in_progress",
...
const mockDecisionTimeline = [
  {
    ...
    timestamp: new Date(),
    type: "ai" as const,
    title: "تم إنشاء توصية الذكاء الاصطناعي",
    description: "توصية بالموافقة بنسبة ثقة 82%",
    actor: "النظام",
  },
  {
    id: "2",
    ...
    title: "تمت اكتمال تحليل السيناريوهات",
    description: "تم تقييم 3 سيناريوهات",
    actor: "أحمد م.",
  },
  {
    id: "3",
    ...
    title: "تم نقل القرار إلى المراجعة",
    description: "إطار مكتمل ← قيد المراجعة",
    actor: "النظام",
  },
  {
    id: "4",
    ...
    type: "action" as const,
    title: "تم تقديم تحليل المخاطر",
    description: "تم توثيق مخاطر جميع السيناريوهات",
    actor: "سارة ك.",
  },
  {
    id: "5",
    ...
    type: "action" as const,
    title: "تم إنشاء القرار",
    description: "بدء سير عمل القرار الجديد",
    actor: "أحمد م.",
  },
];
